...
(function heroSlideshow() {
  const slides = Array.from(document.querySelectorAll('.hero-main-image .slide'));
  ...
  // helper: normalize z-index + classes
  ...
  function showSlide(index) {
    ...
    // optional: mark previous slide for smoother transitions if needed
  ...
  function start() {
    stop();
    intervalId = setInterval(goNext, slideInterval);
  }
